...
import '../modals/quotes_models.dart';
...
List<QuoteModal> allQuotes = allQuoteData
    .map(
      (e) => QuoteModal.fromMap(data: e),
    )
    .toList();
...
List<Color> quoteColors = [
  ...
  const Color(0xff4682B4),
  const Color(0xff00CED1),
  const Color(0xff28E0AF),
  const Color(0xff28AE89),
  const Color(0xff28E0AF),
]; // <Colors>
